...
This above needs careful re-thinking, deeper than I thought - for eg, should ManagerRole Iwas thinking s'd be Admin (as Named by me) or JustAnotherName {coz Admin name is already reserved coined for admin-dashboard-one aka superuser in Django lingo}
