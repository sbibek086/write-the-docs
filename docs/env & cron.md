...
1) .env folder lets you default-ize what path we want our tail URL to append with base path URL. That base path url is menioned in .env folder.
...
---
<img width="585" height="732" alt="image" src="https://github.com/user-attachments/assets/20432ef1-f4b0-4a4d-aa8d-a46bc1bfd710" />

---
2) cron:

<img width="538" height="650" alt="image" src="https://github.com/user-attachments/assets/5e5f0fdb-28dc-44a6-91a0-67b4280021e5" />
