...
so, 192.168.1.2 subnet w 255.255.0.0 produces 192.168.1.2 as inside its LAN. 
...
Liekwise, another scenario: 

10.74.0.1/24  aka 10.74.0.1 ma netmask 24 means: LSB bata 24 bits samma change vayeko range hamro virtual private server vayo ie VPS
...
<img width="1098" height="269" alt="image" src="https://github.com/user-attachments/assets/da5b49dd-331f-4703-a736-20fe603358d7" />

---
IP ko kura ta analogy bata bujhyau, IP bhitra ko port ko kura garau:
<img width="790" height="603" alt="image" src="https://github.com/user-attachments/assets/5948573f-cd28-4bc3-a99c-b4f3c5458984" />

----
Dessert concept: hmm, why not extend to btc n eth

<img width="208" height="153" alt="image" src="https://github.com/user-attachments/assets/00b0d041-2e37-48d2-b837-27a0c505cdef" />
