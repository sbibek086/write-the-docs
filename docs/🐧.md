...
---
_fyi: Linux ma FIRST ma, sudo apt update harek choti garnai parxa

THEN

sudo apt install (python3- canBeAnyOther) (python3-pip-meanspython3InterpreterRapython3pipDiutaiInstallGara)

() meaning is here like: (S)he goes to school._
...
b) Configuration Management Systems: Tools like Ansible, Puppet provide ways to automate configuration management across multiple systems, enforcing desired states defined in configuration files.

<img width="519" height="84" alt="image" src="https://github.com/user-attachments/assets/183837ed-9e98-4c84-8d32-730a3e4317f2" />
